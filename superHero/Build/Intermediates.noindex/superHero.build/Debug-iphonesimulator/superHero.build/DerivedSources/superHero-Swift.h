...
#ifndef SUPERHERO_SWIFT_H
#define SUPERHERO_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="superHero",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9superHero11AppDelegate")
...
SWIFT_CLASS("_TtC9superHero18BaseViewController")
@interface BaseViewController : UIViewController <UITableViewDataSource>
- (NSInteger)tableView:(UITableView * _Nonnull)tableView numberOfRowsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
- (UITableViewCell * _Nonnull)tableView:(UITableView * _Nonnull)tableView cellForRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
@property (nonatomic, weak) IBOutlet UISegmentedControl * _Null_unspecified segUniverse;
@property (nonatomic, weak) IBOutlet UITableView * _Null_unspecified tblSuperheroList;
- (void)viewDidLoad;
- (void)getSetector:(UISegmentedControl * _Nonnull)sender;
...
SWIFT_CLASS("_TtC9superHero13SceneDelegate")
...
SWIFT_CLASS("_TtC9superHero14SuperHeroCells")
@interface SuperHeroCells : UITableViewCell
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified imgSuperHeroTableCell;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified lblSuperHeroName;
